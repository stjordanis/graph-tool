...
python::object mode_clustering_multilevel_mcmc_sweep(python::object omcmc_state,
...
void export_mode_cluster_multilevel_mcmc()
{
    using namespace boost::python;
    def("mode_clustering_multilevel_mcmc_sweep",
        &mode_clustering_multilevel_mcmc_sweep);
}
