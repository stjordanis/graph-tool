...
#include "graph_blockmodel_multilevel_mcmc.hh"
...
python::object do_multilevel_mcmc_sweep(python::object omcmc_state,
...
python::object do_multilevel_mcmc_sweep_parallel(python::object omcmc_states,
...
void export_blockmodel_multilevel_mcmc()
{
    using namespace boost::python;
    def("multilevel_mcmc_sweep", &do_multilevel_mcmc_sweep);
    def("multilevel_mcmc_sweep_parallel", &do_multilevel_mcmc_sweep_parallel);
}
