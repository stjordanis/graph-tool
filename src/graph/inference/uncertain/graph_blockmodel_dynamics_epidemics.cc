...
python::object make_epidemics_state(boost::python::object oblock_state,
                              boost::python::object oepidemics_state)
{
    python::object state;
...
void export_epidemics_state()
{
    using namespace boost::python;

    def("make_epidemics_state", &make_epidemics_state);
