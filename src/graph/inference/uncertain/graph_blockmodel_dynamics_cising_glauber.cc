...
python::object make_cising_glauber_state(boost::python::object oblock_state,
                              boost::python::object ocising_glauber_state)
{
    python::object state;
...
void export_cising_glauber_state()
{
    ...
    def("make_cising_glauber_state", &make_cising_glauber_state);
