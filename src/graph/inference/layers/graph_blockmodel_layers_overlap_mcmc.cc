...
python::object mcmc_layered_overlap_sweep(python::object omcmc_state,
...
python::object mcmc_layered_overlap_sweep_parallel(python::object omcmc_states,
...
void export_layered_overlap_blockmodel_mcmc()
{
    using namespace boost::python;
    def("mcmc_layered_overlap_sweep", &mcmc_layered_overlap_sweep);
    def("mcmc_layered_overlap_sweep_parallel", &mcmc_layered_overlap_sweep_parallel);
}
