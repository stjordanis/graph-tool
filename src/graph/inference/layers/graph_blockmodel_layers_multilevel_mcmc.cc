...
python::object multilevel_mcmc_layered_sweep(python::object omcmc_state,
...
python::object multilevel_mcmc_layered_sweep_parallel(python::object omcmc_states,
...
void export_layered_blockmodel_multilevel_mcmc()
{
    using namespace boost::python;
    def("multilevel_mcmc_layered_sweep", &multilevel_mcmc_layered_sweep);
    def("multilevel_mcmc_layered_sweep_parallel", &multilevel_mcmc_layered_sweep_parallel);
}
