...
#include "../overlap/graph_blockmodel_overlap_vacate.hh"
...
python::object vacate_layered_overlap_sweep(python::object ovacate_state,
        ...
        layered_block_state<state_t>::dispatch
            (olayered_state,
             [&](auto& ls)
             {
                 ...
                 merge_overlap_block_state<layered_state_t>::make_dispatch
                     (ovacate_state,
                      [&](auto& s)
                      {
