...
#include "graph_ranked_multilevel_mcmc.hh"
...
python::object ranked_multilevel_mcmc_sweep(python::object omcmc_state,
                                            ...
                                            rng_t& rng)
{
    ...
    auto dispatch_d = [&](auto* dstate)
    {
        ...
        ranked_state<dstate_t>::dispatch(oblock_state, dispatch, false);
    };
    block_state::dispatch(dispatch_d);
    return ret;
}

void export_ranked_multilevel_mcmc()
{
    using namespace boost::python;
    def("ranked_multilevel_mcmc_sweep", &ranked_multilevel_mcmc_sweep);
}
