...
#include "graph_ranked_multiflip_mcmc.hh"
...
python::object ranked_multiflip_mcmc_sweep(python::object omcmc_state,
...
void export_ranked_multiflip_mcmc()
{
    using namespace boost::python;
    def("ranked_multiflip_mcmc_sweep", &ranked_multiflip_mcmc_sweep);
}
