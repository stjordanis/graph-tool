...
python::object norm_cut_multiflip_mcmc_sweep(python::object omcmc_state,
...
void export_norm_cut_multiflip_mcmc()
{
    using namespace boost::python;
    def("norm_cut_multiflip_mcmc_sweep", &norm_cut_multiflip_mcmc_sweep);
}
